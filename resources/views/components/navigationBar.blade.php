    ...
    <nav class="flex justify-between items-center w-[92%] mx-auto">
        ...
        <div
            ...
            <ul class="flex md:flex-row flex-col md:items-center md:gap-[4vw] gap-8 ">
                ...
                <li>
                    <a class="hover:text-secondary-500 {{ $activePage === 'about-us' ? 'font-bold text-secondary-500 border-b-2 border-secondary-500' : '' }}" href="#">About
                        Us</a>
                </li>

                <li>
                    <a class="hover:text-secondary-500 {{ $activePage === 'my-ride' ? 'font-bold text-secondary-500 border-b-2 border-secondary-500' : '' }}" href="#">My
                        Rides</a>
                </li>

                <li>
                    <a class="hover:text-secondary-500 {{ $activePage === 'car-details' ? 'font-bold text-secondary-500 border-b-2 border-secondary-500' : '' }}" href="#">Car
                        Details</a>
                </li>

                <li>
                    <a class="hover:text-secondary-500 {{ $activePage === 'account' ? 'font-bold text-secondary-500 border-b-2 border-secondary-500' : '' }}" href="#">My
                        account</a>
                </li>

                <li>
                    <a class="hover:text-secondary-500 {{ $activePage === 'find-car' ? 'font-bold text-secondary-500 border-b-2 border-secondary-500' : '' }}" href="#">Find A Car</a>
                </li>
